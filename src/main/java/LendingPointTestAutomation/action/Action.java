...
public class Action extends LendingPointTestAutomation.baseClass.BaseClass {
	...
	/*
	 * WebElement element = driver.findElement(By.tagName("div")); // Get all the
	 * elements available with tag name 'p' List<WebElement> elements =
	 * element.findElements(By.tagName("p")); for (WebElement e : elements) {
	...
	public static int getElementCount(List<WebElement> ele) {
		int a = ele.size();
		return a;
	}
